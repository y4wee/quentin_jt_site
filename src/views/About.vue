    ...
    <div class="about">
        ...
        <div class="aboutMain">
            <div class="aboutMainPresentation">
                ...
                <div
                    class="aboutMainPresentationText"
                    v-if="language === 'Eng'"
                >
                    Hey ! <br />
                    I am Quentin,<br />
                    a French and junior web developer located in the Bordeaux
                    region. <br />
                    ...
                    since then I have continued to increase my skills in this
                    environment,<br />
                ...
                <div class="aboutMainPresentationText" v-else>
                    Hey ! <br />
                    C'est Quentin,<br />
                    un développeur web français et junior situé en région
                    bordelaise. <br />
                    Je suis un rêveur, un joueur, curieux et optimiste de
                    nature, à l’écoute des autres et n’oublions pas que j’aime
                    les chats !<br />
                    Après quelques années de recherche sur moi-même,<br />
                    Je me suis plongé dans ce vaste monde qu'est la
                    programmation en 2021, depuis je ne cesse d’accroître mes
                    compétences dans ce milieu,<br />
                    Un milieu qui est une passion,<br />
                    Une passion que j’aime cultiver et développer.<br />
                    Je vous laisse donc découvrir les cartes que j’ai en ma
                    possession.
                </div>
                ...
                <div
                    ...
                    v-if="language === 'Eng'"
                >
                    Strongly looking for new experiences in this environment,<br />
                    I am a Front-end <br />
                    developer with an appetite for UX / UI design and some
                    knowledges in Back-end side.<br />
                    Being a logical and careful person, I like to solve problems
                    and find solutions most suitable while adopting a clean and
                    maintainable code.<br />
                    I am Adaptable and I like to discover and learn new
                    technologies, <br />
                    so if you are interested in my profile, I invite you to
                    follow this link ...
                </div>
                <div class="aboutMainPresentationText" v-else>
                    Vivement à la recherche de nouvelles expèriences dans ce
                    milieu,<br />
                    je suis un développeur <br />
                    Front-end avec une appétence pour l'UX/UI design et quelques
                    connaissances côté Back-end.<br />
                    Etant une personne logique et minutieuse, j'aime résoudre
                    des problèmes et en trouver les solutions les plus adaptées
                    tout en adoptant un code propre et maintenable.<br />
                    Je suis Adaptable et j'aime découvrir et apprendre de
                    nouvelles technologies, <br />
                    alors si vous êtes intéressé par mon profil, je vous invite
                    à suivre ce lien…
                </div>

                <div class="aboutMainPresentationContact">
                    <div
                        class="aboutMainPresentationContactGear"
                        @click="goToContact()"
                    >
                        <div class="aboutMainPresentationContactGearBump"></div>
                        <div class="aboutMainPresentationContactGearCenter">
                            Contact
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        goToContact: function () {
            ...
            tl.to(
                ".logo",
                { xPercent: 0, duration: 0.5, ease: "power3.in" },
                "-=0.45"
            );
            tl.to(
                "header",
